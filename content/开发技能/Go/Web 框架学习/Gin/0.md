...
2.1 初始化 Gin （Default 函数）
初始化步骤主要是初始化 engine 与加载两个默认的中间件：
```go
...
![](resource/Pasted%20image%2020250317152939.png)
...
![](resource/Pasted%20image%2020250317153014.png)
...
[原文地址](https://mp.weixin.qq.com/s/T-rJjiyvp5dIdnGIVY-OcA)
